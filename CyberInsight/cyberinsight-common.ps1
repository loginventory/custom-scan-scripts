...
function Resolve-CI-EffConfig {
    ...
    $exportQuery  = Get-EffectiveValue -Primary $Parameters -Fallback $fileCfg -Name 'CyberInsightExportQuery' -As string -Default 'IT Inventory\Vulnerabilities\Vulnerability Export'
